...
If you're new to this repo and looking to get started, see the [DaC Abridged Guide](./dac_abridged_guide.md) to get set up and running. Then review the full [DaC Concept and Workflows](./dac_concept_and_workflows.md) and the rest of documentation in this guide for more information on concepts and workflows that you may want to use when setting up your CI/CD. 
